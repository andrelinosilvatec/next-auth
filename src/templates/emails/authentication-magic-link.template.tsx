...
export function AuthenticationMagicLinkTemplate({
  ...
  const previewText = `Faça login na aplicação`
        ...
        <Body className="m-auto bg-white font-sans">
          <Container className="mx-auto my-[40px] w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
            ...
            <Text className="text-[14px] leading-[24px] text-black">
              Você solicitou um link para login na aplicação através do email{' '}
              {userEmail}.
            </Text>
            ...
            <Text className="text-[12px] leading-[24px] text-[#676767]">
